  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        dropdown: "appearance-none bg-secondary text-foreground border border-border rounded-lg px-2 py-1 text-sm font-medium cursor-pointer hover:bg-accent focus:outline-none focus:ring-2 focus:ring-primary/50",
        dropdown_month: "mr-1",
        dropdown_year: "",
        vhidden: "sr-only",
        ...
        nav_button: cn(
          ...
          "h-8 w-8 bg-secondary border-border p-0 hover:bg-accent hover:text-accent-foreground transition-colors",
        ),
