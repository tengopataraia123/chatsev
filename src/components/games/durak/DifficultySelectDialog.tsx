// Difficulty selection dialog for bot games
...
interface DifficultySelectDialogProps {
  open: boolean;
...
const difficulties: {
  ...
  },
  {
    id: 'medium',
    name: 'საშუალო',
    description: 'ძირითადი სტრატეგია - ბოტი იცავს ტრამპებს',
    icon: Zap,
...
const DifficultySelectDialog = memo(function DifficultySelectDialog({
  open,
  onOpenChange,
  onSelect,
  gameName = 'თამაში',
}: DifficultySelectDialogProps) {
  return (
...
export default DifficultySelectDialog;
