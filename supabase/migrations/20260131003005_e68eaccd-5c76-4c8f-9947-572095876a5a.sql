-- Fix the delete_expired_stories function to handle duplicate notifications
...
BEGIN
  ...
  LOOP
    ...
    -- Use ON CONFLICT to skip if notification already exists
    IF view_count > 0 OR reaction_count > 0 THEN
      BEGIN
        ...
        ON CONFLICT (user_id, from_user_id, type, COALESCE(post_id, '00000000-0000-0000-0000-000000000000'::uuid)) DO NOTHING;
      EXCEPTION WHEN OTHERS THEN
        -- Silently skip notification errors
        NULL;
      END;
    END IF;
