...
DROP POLICY IF EXISTS "Admins can update any user privacy settings" ON public.privacy_settings;
DROP POLICY IF EXISTS "Admins can insert privacy settings for any user" ON public.privacy_settings;
